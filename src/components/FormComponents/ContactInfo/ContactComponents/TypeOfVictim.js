    ...
    return (
      <div>
        <FormControl className={classes.formControl}>
          ...
          >
            <MenuItem style={{ width: "100%" }} value="adult primary">
              Adult Primary Victim
            </MenuItem>
            <Divider />
            <MenuItem style={{ width: "100%" }} value="youth primary">
              Youth Primary Victim
            </MenuItem>
            <Divider />
            <MenuItem style={{ width: "100%" }} value="adult secondary">
              Adult Secondary Victim
            </MenuItem>
            <Divider />
            <MenuItem style={{ width: "100%" }} value="youth secondary">
              Youth Secondary Victim
            </MenuItem>
          </Select>
        </FormControl>
      </div>
