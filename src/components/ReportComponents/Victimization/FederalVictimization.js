  ...
  render() {
    return (
      <section className="victimization">
        <h4>
          Types of Victimization: total number during the reporting period
        </h4>
        <Table className="federalTable">
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>
                {this.props.state.getFederalReducer.violence_adult_sexual}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>
              ...
              <TableCell>
                {
                  this.props.state.getFederalReducer
            ...
            <TableRow>
              <TableCell>
                Adult Sexually Abused/Assaulted as Children by Family
              </TableCell>
              <TableCell>
                {
                  this.props.state.getFederalReducer
            ...
            <TableRow>
              ...
              <TableCell>
                {this.props.state.getFederalReducer.violence_bullying}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Child Pornography</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_child_pornography}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Child Sexual Abuse/Assault Total</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_minor_total}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Child Sexual Abuse/Assault by Family</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_minor_by_family}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Child Sexual Abuse/Assault by Other</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_minor_by_other}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Domestic And/Or Family Violence</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_domestic}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Elder Abuse or Neglect</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_elder}
              </TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell>
                {this.props.state.getFederalReducer.violence_exposing}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Stalking/Harassment - Harassment</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_harassment}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Stalking/Harassment - Internet</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_internet}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Stalking/Harassment - Phone</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_phone}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Stalking/Harassment - Stalking</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_stalking}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Teen Dating Victimization</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_teen_dating}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Unknown/Pass/Doesn't Know</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_unknown}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Other</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.violence_other}
              </TableCell>
            </TableRow>
            <TableRow>
