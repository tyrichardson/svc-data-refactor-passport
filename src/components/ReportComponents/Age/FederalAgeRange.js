        ...
        <Table className="federalTable">
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>
                {this.props.state.getFederalReducer.victim_age_zero_to_twelve}
              </TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell>
                {this.props.state.getFederalReducer.victim_age_sixty_and_older}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Not Reported</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.victim_age_unknown}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Total:</TableCell>
              <TableCell>
                {this.props.state.getFederalReducer.total_age_count}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
