    ...
    return (
      <div>
          ...
          <Paper style={style.paper}>
            ...
            >
              <DateCustom
                ...
                handleChangeForQuerySelector={this.handleChangeForQuerySelector}
                startDate={this.state.startDate}
                endDate={this.state.endDate}
                submitCustomReport={this.submitCustomReport}
                handleChangeForEndDate={this.handleChangeForEndDate}
              ...
              >
                <CustomAge
                  ...
                  handleDelete={this.handleDelete("AgeCustomSelection")}
                  selectedItem={this.state.AgeCustomSelection}
                ...
                <CustomContactType
                  ...
                  handleDelete={this.handleDelete("CustomContactTypeSelection")}
                  selectedItem={this.state.CustomContactTypeSelection}
                  inputValue={this.state.inputValue}
                />
                <CustomDisability
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  handleDelete={this.handleDelete("CustomDisabilitySelection")}
                  selectedItem={this.state.CustomDisabilitySelection}
                  inputValue={this.state.inputValue}
                />
                <CustomGender
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  handleDelete={this.handleDelete("CustomGenderSelection")}
                  selectedItem={this.state.CustomGenderSelection}
                  inputValue={this.state.inputValue}
                />
                <ImmigrantCountryCustom
                  ...
                  selectedItem={this.state.ImmigrantCountryCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <IndividualsServiced
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  selectedItem={this.state.IndividualsServicedSelection}
                  inputValue={this.state.inputValue}
                />
                <CrisisCounseling
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  handleDelete={this.handleDelete("CrisisCounselingSelection")}
                  selectedItem={this.state.CrisisCounselingSelection}
                  inputValue={this.state.inputValue}
                />
                <AdvocacyCivilCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  selectedItem={this.state.AdvocacyCivilCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <AdvocacyCriminalCustom
                  ...
                  selectedItem={this.state.AdvocacyCriminalCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <AdvocacyMedicalCustom
                  ...
                  selectedItem={this.state.AdvocacyMedicalCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <AdvocacyOtherCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  selectedItem={this.state.AdvocacyOtherCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <PhoneServicesCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  selectedItem={this.state.PhoneServicesCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <PoliceReportCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  selectedItem={this.state.PoliceReportCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <RaceEthnicityCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  selectedItem={this.state.RaceEthnicityCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <SexualOrientationCustom
                  ...
                  selectedItem={this.state.SexualOrientationCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <SpecialClassificationCustom
                  ...
                  selectedItem={this.state.SpecialClassificationCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <LocationCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  handleDelete={this.handleDelete("LocationCustomSelection")}
                  selectedItem={this.state.LocationCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <SupportOnCallCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  selectedItem={this.state.SupportOnCallCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <TransgenderedCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                ...
                <VictimTypeCustom
                  ...
                  handleDelete={this.handleDelete("VictimTypeCustomSelection")}
                  selectedItem={this.state.VictimTypeCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <UnmetNeedsCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  handleDelete={this.handleDelete("UnmetNeedsCustomSelection")}
                  selectedItem={this.state.UnmetNeedsCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <TypesOfVictimizationCustom
                  ...
                  selectedItem={this.state.TypesOfVictimizationCustomSelection}
                  inputValue={this.state.inputValue}
                />
                <ZipCodeCustom
                  handleChangeForComponent={this.handleChangeForComponent(
                  ...
                  handleDelete={this.handleDelete("ZipCodeCustomSelection")}
                  selectedItem={this.state.ZipCodeCustomSelection}
        ...
        {this.state.isOpen === true && (
          <CalendarModal handleClose={this.closeModel} />
        )}
      </div>
    ); //end return
  } //end render
