...
import GenderObject from '../ObjectLists/Gender.Object';
...
class GenderCustom extends React.Component {
  state = {
    inputValue: '',
  };
...
GenderCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledGenderCustom = withStyles(styles)(GenderCustom);
export default connect(mapStateToProps)(styledGenderCustom)
