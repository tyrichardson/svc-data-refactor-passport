...
* Create a new PostgreSQL database called `svc-data` and run the database.sql file found in the root of these project files.
...
To add an Admin user after creating DB and Tables, you can run the following insert statement, login, navigate to User Entry Page, add a new Admin user, test that it works, and then delete this test admin user.

INSERT INTO user (“username”, “password”, “user_type”) VALUES (‘ty’, ‘$2a$10$3ynnUgcr3FucUYuJm.Fs3uvvAtH3mFgN9vSQj5rLnbZid/pjviYXy’, true);
